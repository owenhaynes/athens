...
import (
	...
	"github.com/gomods/athens/pkg/module/subdirfetcher/gosrc/cfg"
	"github.com/gomods/athens/pkg/module/subdirfetcher/gosrc/str"
)
...
func WorkDir(WorkRoot, typ, name string) (dir string, err error) {
