...
import (
	...
	"github.com/gomods/athens/pkg/module/subdirfetcher/gosrc/modfile"
	"github.com/gomods/athens/pkg/module/subdirfetcher/gosrc/module"
...
type CodeRepo struct {
	...
	// the offset of the code in the repo
	codeOffset string 
}
...
func NewCodeRepo(code codehost.Repo, codeRoot, path, codeOffset string) (Repo, error) {
...
func (r *CodeRepo) Zip(dst io.Writer, version string) error {
	...
	haveLICENSE := false
	topPrefix := path.Join("prefix/", r.codeOffset)
